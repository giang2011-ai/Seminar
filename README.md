...
Dự án sử dụng bộ dữ liệu X-quang phổi từ Kaggle. Do kích thước dữ liệu lớn, thư mục `data/` không được đưa lên GitHub. Bạn cần tự tải và thiết lập dữ liệu theo các bước sau:

**Bước 1: Tải dữ liệu**

- Truy cập vào link Kaggle: [X-Ray Vision CNN for Lung Diseases](https://www.kaggle.com/code/zulqarnain11/x-ray-vision-cnn-for-lung-diseases)
- Tìm đến mục **Input** (hoặc Data) trong Notebook trên để tải bộ dataset gốc về máy tính của bạn (dưới dạng file `.zip`).

**Bước 2: Giải nén và thiết lập cấu trúc**
- Giải nén file dữ liệu vừa tải về.
- Thêm thư mục `data` vào thư mục gốc. 
